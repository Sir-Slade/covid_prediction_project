...
- [WebAPP](https://github.com/Sir-Slade/covid_prediction_project/): The directory containing the Covid Detector flask app that is deployed, including the TrainingScript.py used to train the model.
